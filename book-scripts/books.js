...
document.addEventListener("alpine:init", () => {
  Alpine.data("booksPage", () => ({
    ...
    calculateVisibleCount() {
      const width = this.$el.querySelector(".scrollable-content div[id*=-content]").getBoundingClientRect().width;
      this.visibleCount = Math.floor(width / this.cardWidth);
      console.log("visibleCount: ", this.visibleCount, "cardWidth: ", this.cardWidth, "width: ", width);
    },
